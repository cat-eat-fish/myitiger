            ...
            <div class="container clearfix">
                    ...
                    <div class="form-main">
                            ...
                            <div class="field-phone-group">
                                <div class="telcode-phone">
                                    ...
                                    <div class="form-group phone">
                                        <input v-model="message_phone"  type="text" placeholder="请输入手机号" name="phone" required="" class="form-control ef-valid">
                                    </div>
                                </div>
                                <div class="send-msg clearfix">
                                    <div class="form-group code has-ef-error">
                                        <input v-model="message_code"   type="text" placeholder="请输入短信验证码" required="" name="code" class="ef-error-required form-control ef-invalid">
                                    </div>
                        ...
                        <div  class="account-form">
                            <div v-if="state.code==1"  class="form-group has-ef-error">
                                <input  v-model="message_email"  type="text" name="email" placeholder="请输入邮箱" class="ef-error-required form-control ef-invalid">
                            </div>
                            <!-- 密码 -->
                            <div class="form-group">
                                <input v-model="message_password" type="password" name="login_password" placeholder="密码，8-24位数字、字母或字符"   class="form-control ef-valid" >
                            </div>
                            <!-- 确认密码 -->
                            <div class="form-group has-ef-error">
                                <input v-model="message_password_confirm" type="password" name="password_confirm" placeholder="请再次输入密码" required=""  class="ef-error-required form-control ef-dirty ef-invalid ef-touched">
                            </div>
                            <!-- 邀请码 -->
                            <div class="form-group">
                ...
                <div v-if="nowstate==2">
                    <div class="form-main">
                        ...
                        <div class="form-group">
                            <input v-model="real_name"  placeholder="您的真实姓名，例如：王小虎" class="form-control" type="text" name="real_name" value="">
                        </div>
                        <div class="real-name-pinyin">
                            <div class="form-group has-error">
                                <input v-model="pinyin_first" placeholder="姓的拼音，例如：wang" pattern="/^[a-zA-Z]+$/" class="form-control" type="text" name="pinyin_first" value="">
                            </div>
                            <div class="form-group has-error">
                                <input v-model="pinyin_last"  placeholder="名的拼音，例如：xiaohu" pattern="/^[a-zA-Z]+$/" class="form-control" type="text" name="pinyin_last" value="">
                            </div>
                        </div>
                            <h3 class="form-title">
                                选择您国籍所在的国家或地区
                            ...
                            <div class="form-group">
                                <select v-model="country_code" class="form-control" type="select" name="country_code">
                            ...
                            <div v-if="multi_area">
                                <div class="multiple-tax-country"><div>
                                    ...
                                    <div class="mutiple-text-form">
                                        <div class="form-group">
                                            <select class="form-control" type="select" v-model="m1tax_residence_country" name="1.tax_residence_country">
                                        ...
                                        <div class="form-group">
                                            <input placeholder="纳税识别号" class="nssbh form-control" type="text"  v-model="m1tax_identification_number" name="1.tax_identification_number" value="" ></div>
                                            <div class="form-group ios-style">
                            ...
                            <div class="id_no-group clearfix">
                                ...
                                <div class="form-group ">
                                    <input v-model="id_no"  pattern="/^[xX0-9]{18}$/" placeholder="身份证号码" class="form-control" type="text" name="id_no" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input v-model="email"  placeholder="电子邮箱" pattern="/^(?![\-_.])[\w\-.]+@(?:(?![\-_])[\w\-一-龥]{1,63}\.)+[A-Za-z0-9]{2,}$/" class="form-control" type="text" name="email" value="">
                            </div>
                            <div class="form-group">
                                <select v-model="family_member"   class="form-control" type="select" name="family_member">
                            ...
                            <div class="form-group">
                                <select v-model="marital_status"   class="form-control" type="select" name="marital_status">
                            ...
                            <div>
                                <div class="form-group">
                                    <select  v-model="job"  class="form-control" type="select" name="job">
                            ...
                            <div class="a-fadeIn">
                                ...
                                <div>
                                    ...
                                    <div class="business-career clearfix">
                                        <div class="form-group business-control">
                                            <select v-model="business"   class="form-control" type="select" name="business">
                                        ...
                                        <div class="form-group career-control">
                                            <select v-model="career"  class="form-control" type="select" name="career">
                                ...
                                <div class="form-group">
                                    <input  v-model="company"   placeholder="单位名称" class="form-control" type="text" name="company" value="">
                                </div>
                                <div class="province-city-group clearfix">
                                    <div class="form-group">
                                        <select v-model="province"  class="form-control" type="select" name="province">
                                            <option value="">选择省份</option>
                                            <option value="北京市">北京市</option>
                                            <option value="天津市">天津市</option>
                                            <option value="河北省">河北省</option>
                                    ...
                                    <div class="form-group">
                                        <select v-model="company_city"   class="form-control" type="select" name="company_city">
                                            <option value="">选择城市</option>
                                    ...
                                    <div class="form-group">
                                        <select v-model="company_area"  class="form-control" type="select" name="company_area">
                                            <option value="">选择地区</option>
                                ...
                                <div class="form-group">
                                    <input v-model="work_address_detail"  placeholder="单位详细地址" class="form-control" type="text" name="work_address_detail" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group-control form-inline ios-style" required="">
                                <div class="group">
                                    <input type="radio" v-model="regulatory_members_checked"  value='1' name="regulatory_members_checked">是
                                </div>
                                <div class="group">
                                    <input type="radio" v-model="regulatory_members_checked"   value="0" name="regulatory_members_checked">否
                                </div>
                            </div>
                            <div class="form-group">账户持有人是否是一家公共上市公司的董事，持10%股权的股东或决策人？</div>
                            <div class="form-group-control form-inline ios-style" required="">
                                <div class="group">
                                    <input type="radio" v-model="regulatory_stockholder_checked"   value='1' name="regulatory_stockholder_checked">是
                                </div>
                                <div class="group">
                                    <input type="radio" v-model="regulatory_stockholder_checked" value='0' name="regulatory_stockholder_checked">否
                                </div>
                            </div>
                    </div>
                </div>
                ...
                <div v-if="nowstate==3">
                    <div class="form-main">
                        ...
                        <div clas   s="form-group">
                            <select v-model="trade_channel" type="select" name="trade_channel" class="form-control ef-valid">
                ...
                <div v-if="nowstate==4" class="form-main">
                    ...
                    <div class="form-group has-ef-error">
                        <select type="select" name="stk_trade_year" v-model="stk_trade_year"  min="1" max="3" class="ef-error-required form-control ef-placeholder ef-invalid">
                    ...
                    <div class="form-group has-ef-error">
                        <select v-model="stk_trade_per_year" type="select" name="stk_trade_per_year"  min="1" class="ef-error-required form-control ef-placeholder ef-invalid">
                    ...
                    <div class="form-group has-ef-error">
                        <select type="select" name="stk_kl" v-model="stk_kl"  min="1" class="ef-error-required form-control ef-placeholder ef-invalid">
                    ...
                    <div class="asset-group">
                        ...
                        <div class="form-group has-ef-error">
                            <select type="select"  name="net_current_assets" v-model="net_current_assets"  min="1" class="ef-error-required form-control ef-placeholder ef-invalid">
                    ...
                    <div class="asset-group">
                        ...
                        <div class="form-group has-ef-error">
                            <select type="select" name="net_assets" v-model="net_assets"  class="ef-error-required form-control ef-placeholder ef-invalid">
                                <option value="">请选择</option>
                                <option value="0">0 - 2万美元</option>
                                <option value="1">2万 - 5万美元</option>
                                <option value="2">5万 - 7.5万美元</option>
                    ...
                    <div class="asset-group">
                        ...
                        <div class="form-group has-ef-error">
                            <select type="select" name="total_assets" v-model="total_assets"  class="ef-error-required form-control ef-placeholder ef-invalid">
                                <option value="">请选择</option>
                                <option value="0">0 - 2万美元</option>
                                <option value="1">2万 - 5万美元</option>
                                <option value="2">5万 - 7.5万美元</option>
                    ...
                    <div class="asset-group">
                        ...
                        <div class="form-group has-ef-error">
                            <select type="select" name="net_year_income" v-model="net_year_income"  min="1" class="ef-error-required form-control ef-placeholder ef-invalid">
                                <option value="">请选择</option>
                    ...
                    <div class="ef-error-required form-group-control ef-invalid form-inline has-ef-error">
                        <div class="form-group">
                            <label>
                                <input label="投机" name="invest_target" v-model="invest_target"  type="checkbox"  class="ef-valid" value="0">投机</label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input label="交易利润" name="invest_target" v-model="invest_target"  type="checkbox"  class="ef-valid" value="1">交易利润
                                </label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input label="长线收益" name="invest_target" v-model="invest_target"  type="checkbox"  class="ef-valid" value="2">长线收益
                                </label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input label="对冲" name="invest_target" v-model="invest_target" type="checkbox"  class="ef-valid" value="3">对冲
                                </label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input label="股息收入" name="invest_target" v-model="invest_target"  type="checkbox"  class="ef-valid" value="4">股息收入
                                </label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input label="低风险保值" name="invest_target" v-model="invest_target" type="checkbox"  class="ef-valid" value="5">低风险保值
                                </label>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="nowstate==5" class="form-main">
                    ...
                    <div class="agreement-group opened">
                        ...
                        <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                            <div class="group">
                                <input type="radio" value="1" v-model="agreement_0" name="agreement_0">本人同意</div>
                            <div class="group">
                                <input type="radio" value="0" v-model="agreement_0"  name="agreement_0">本人不同意
                            </div>
                        </div>
                    </div>
                        <div class="agreement-group opened">
                            ...
                            <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                                <div class="group">
                                    <input type="radio" value="1" v-model="agreement_1" name="agreement_1">本人同意
                                    </div>
                                <div class="group">
                                    <input type="radio" value="0" v-model="agreement_1"  name="agreement_1">本人不同意
                                    </div>
                            </div>
                        </div>
                        <div class="agreement-group opened">
                            ...
                            <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                                <div class="group">
                                    <input type="radio" value="1" v-model="agreement_2" name="agreement_2">本人同意</div>
                                <div class="group">
                                    <input type="radio" value="0" v-model="agreement_2" name="agreement_2">本人不同意</div>
                                </div>
                            </div>
                            <div class="agreement-group opened">
                                ...
                                <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                                    <div class="group"><input value="1" type="radio" v-model="agreement_3"  name="agreement_3">本人同意
                                </div>
                                <div class="group">
                                    <input type="radio" value="0" v-model="agreement_3"  name="agreement_3">本人不同意
                                </div>
                            </div>
                        </div>
                        <div class="agreement-group opened">
                            ...
                            <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                                <div class="group">
                                    <input type="radio" value="1" v-model="agreement_4"  name="agreement_4">本人同意
                                </div>
                                <div class="group">
                                    <input type="radio" value="0" v-model="agreement_4"  name="agreement_4">本人不同意</div>
                                </div>
                        </div>
                    <div class="agreement-group opened">
                        ...
                        <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                            <div class="group">
                                <input type="radio" value="1" v-model="agreement_5"  name="agreement_5">本人同意
                            </div>
                            <div class="group">
                                <input type="radio" value="0" v-model="agreement_5"   name="agreement_5">本人不同意
                            </div>
                        </div>
                    </div>
                    <div class="agreement-group opened">
                        ...
                        <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                        <div class="group">
                            <input type="radio" value="1" v-model="agreement_6"   name="agreement_6">本人同意</div>
                            <div class="group"><input value="0" v-model="agreement_6"  type="radio" name="agreement_6">本人不同意</div>
                        </div>
                    </div>
                    <div class="agreement-group opened">
                        ...
                        <div class="form-group-control form-inline ios-style" pattern="/^1$/" required="">
                            <div class="group">
                                <input value="1" v-model="agreement_7"   type="radio" name="agreement_7">本人同意
                            </div>
                            <div class="group">
                                <input type="radio" value="0" v-model="agreement_7"  name="agreement_7">本人不同意
                            </div>
                        </div>
                    </div>
                    <div class="agreement-group opened">
                        ...
                        <div class="form-group-control form-inline ios-style" pattern="/^1$/" required=""><div class="group">
                            <input type="radio" value="1" v-model="agreement_8"  name="agreement_8">本人同意</div>
                            <div class="group">
                                <input type="radio" value="0" v-model="agreement_8" name="agreement_8">本人不同意
                            </div>
                        </div>
                    </div>
...
export default {
  ...
  mounted() {
    ...
    btna.forEach(function(item, index) {
      item.nextElementSibling.style.cssText =
        "height:0px;padding:0px;transition:all 0.5s";
  ...
  methods: {
    // 下一步验证
    onenext() {
        var pattphone = /^1[3456789][0-9]{9}$/;
        var pattpass = /^[A-Za-z0-9]{4,40}$/;
        if(this.state.code == 0){
            if(this.message_phone == ''){
                this.state.err = '请输入手机号码'
                return false;
            }else if(!pattphone.test(this.message_phone)){
                this.state.err = '手机号码格式不正确'
                return false;
            }else if(this.message_code == ''){
                this.state.err = '请输入短信验证码'
                return false;
            }else if(this.message_password == ''){
                this.state.err = '请输入密码'
                return false;
            }else if(!pattpass.test(this.message_password)){
                this.state.err = '密码格式不正确'
                return false;
            }else{
  ...
  .container {
    ...
    .form-main {
      ...
      .residence-address-box {
        background-color: hsla(51, 17%, 79%, 0.32);
        padding: 10px;
        margin-bottom: 20px;
        border-radius: 3px;
        .province-city-group {
